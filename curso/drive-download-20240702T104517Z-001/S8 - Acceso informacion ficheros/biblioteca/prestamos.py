...
class GestionPrestamos: 
    ...
    def anadir_prestamo(self, dni, isbn, fecha):
        ...
        # Validar si existe libro mediante el metodo "buscar_libro" de la clase GestionUsuarios

        resultados = self.gestionLibros.buscar_libro(isbn)
        if not resultados: 
            print("No se ha encontrado libro con este dni " + isbn)
            return
